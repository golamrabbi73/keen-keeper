...
const plusIcon = "/images/Vector.png";
        ...
        <header>
                ...
                <div className="max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center mx-auto gap-6">
                    <div className="card w-65 bg-base-100 card-md shadow-sm p-8 text-center">
                        <h2 className="font-semibold text-[#244D3F] text-4xl mb-2">10</h2>
                        <p className="text-[#64748B]">Total Friends</p>
                    </div>
                    <div className="card w-65 bg-base-100 card-md shadow-sm p-8 text-center">
                        <h2 className="font-semibold text-[#244D3F] text-4xl mb-2">3</h2>
                        <p className="text-[#64748B]">On Track</p>
                    </div>
                    <div className="card w-65 bg-base-100 card-md shadow-sm p-8 text-center">
                        <h2 className="font-semibold text-[#244D3F] text-4xl mb-2">6</h2>
                        <p className="text-[#64748B]">Need Attention</p>
                    </div>
                    <div className="card w-65 bg-base-100 card-md shadow-sm p-8 text-center">
                        <h2 className="font-semibold text-[#244D3F] text-4xl mb-2">12</h2>
